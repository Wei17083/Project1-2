...
public class SolarSystem implements FunctionInterface {
    ...
    public static void main(String[] args) {
        ...
        Body moon = new Body("Moon", 7.349e22, 
                ...
                new Vector(4.433121605215677e+03, -2.948453614110320e+04, 8.896598225322805e+01), 1.7375e6,
                Color.gray);
        ...
        Body neptune = new Body("Neptune", 1.02413e26, 
                ...
                new Vector(1.068410720964204e+03, 5.354959501569486e+03, -1.343918199987533e+02), 2.4622e7,
                Color.blue);
        ...
        Body earth = new Body("Earth", 5.97219e24,
                ...
                new Vector(5.427193405797901e+03, -2.931056622265021e+04, 6.575428158157592e-01), 6371e3, 
        ...
        Body[] bodies = new Body[] { sun, earth, saturn, titan, neptune, uranus, jupiter, mars, moon, venus, mercury}; // sort bodies by distance from sun {sun, planet,
                                                                  // moons, next planet}
