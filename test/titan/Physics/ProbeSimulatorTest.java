...
class ProbeSimulatorTest {
    ...
    private static Body sun = new Body("Sun", 0, 1.988500e30,
    ...
    private static Body mercury = new Body("Mercury", 1, 3.302e23,
    ...
    private static Body venus = new Body("Venus", 2, 4.8685e24,
    ...
    private static Body earth = new Body("Earth", 3, 5.97219e24,
    ...
    private static Body moon = new Body("Moon", 4, 7.349e22,
    ...
    private static Body mars = new Body("Mars", 5, 6.4171e23,
    ...
    private static Body jupiter = new Body("Jupiter", 6, 1.89813e27,
    ...
    private static Body saturn = new Body("Saturn", 7, 5.6834e26,
    ...
    private static Body titan = new Body("Titan", 8, 1.34553e23,
    ...
    private static Body uranus = new Body("Uranus", 9, 8.6813e25,
    ...
    private static Body neptune = new Body("Neptune", 10, 1.02413e26,
    ...
    @Test void testTrajectoryLength() {
        ...
        assertEquals(366, trajectory.length);
    ...
    public static Vector3dInterface[] simulateOneDay() {
      ...
      double day = 24*60*60;
        ...
        ProbeSimulatorInterface simulator = new Probe(system, system.solve(system, system.getState(), 31556926, stepSize));
